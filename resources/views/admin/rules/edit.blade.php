    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
{!! Form::model($aturan, ['route' => ['rules.update', $aturan->id_aturan], 'method' => 'PUT', 'files' => true ]) !!}
...
<div class="row">
  <div class="col-md-8">
    ...
    {{ Form::label('id_aplikasi', "Tool", ['class' => 'form-spacing-top']) }}
  ...
  <div class="col-md-4">
    <div class="well">
      ...
      <div class="row">
         <div class="col-sm-5">
           {!! Html::linkRoute('rules.show', 'Cancel', array($aturan->id_aturan), array('class' => 'btn btn-danger btn-block')) !!}
